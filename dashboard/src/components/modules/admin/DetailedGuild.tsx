			...
			<Modal isOpen={isOpen} onClose={onClose} isCentered>
				...
				>
					<ModalHeader>
						...
						>
							<HStack spacing="1em">
								<Image src={iconURL} alt={name} w="100px" h="100px" borderRadius="50%" />
							...
							<Wrap spacing="5em">
								<TextSection title="Last Activity">
									<Tag bg={getActivityColor(lastInteract).replace('500', useColorModeValue('100', '900'))}>
										...
										<Text>{lastInteract ? timeAgo.format(new Date(lastInteract).getTime()) : 'N/A'}</Text>
									</Tag>
								</TextSection>
