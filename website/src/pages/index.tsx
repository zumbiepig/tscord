...
const HomePage: NextPage<Props> = ({ botData, articles }) => {
	...
	return (
		<>
			...
			>
				<HeroBanner title={title} iconUrl={botData.info.iconUrl} description={config.site.description} />
				...
				<Box p="2em">
					...
					<SimpleGrid columns={{ base: 1, lg: 3 }} gap={{ base: 6, lg: 20 }}>
						<HomeStat label="Guilds" value={botData.totals.stats.totalGuilds} icon={<SiClubhouse />} color="#7A4069" />

						<HomeStat label="Users" value={botData.totals.stats.totalUsers} icon={<FaUserFriends />} color="#513252" />
