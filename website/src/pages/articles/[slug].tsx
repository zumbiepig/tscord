...
const defaultArticlePageIcon =
  'https://cdn-icons-png.flaticon.com/512/3500/3500995.png';
    ...
    <>
      <Head>
        ...
        <link
          rel="icon"
          type="image/png"
          href={config.site.icon || defaultArticlePageIcon}
        />
      </Head>
...
export const getStaticPaths: GetStaticPaths = async () => {
  const files = fs
    .readdirSync(config.articlesPath)
    .filter((file) => !file.startsWith('.') || !file.startsWith('_'));
  const slugs = files.map((fileName: string) =>
