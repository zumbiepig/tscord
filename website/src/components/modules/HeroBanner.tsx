...
export const HeroBanner: React.FC<HeroBannerProps> = ({ iconUrl, title, description }) => {
	...
	return (
		<>
			<Box as="section" zIndex={-1} sx={{ transformStyle: 'preserve-3d' }} w="100%">
				<Box
					as={Parallax}
					speed={parallaxSpeed}
				...
				<Flex
					...
					height="100vh"
				>
					<Image src={iconUrl} alt={title + ' logo'} w={iconSize} h={iconSize} borderRadius="50%" mb="24px" />
					...
					<Link
						...
						justifyContent="center"
					>
						<Text fontFamily="Inter var,Inter,sans-serif" fontWeight="bold" color="white">
							Add to Discord
						</Text>
					</Link>
				</Flex>
